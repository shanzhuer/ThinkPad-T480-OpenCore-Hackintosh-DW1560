...
- update 20220603
  - 由于需要使用部分32位应用，系统降级为Mojave（10.14），另外为完善wifi功能更换了dw1560博通方案网卡，对本repo做了少量改动，首先去除intel无线网卡相关kext，加入dw1560相关kext。 最重要的一点，由于dw1560蓝牙模块是走的伪usb，所以usbinjectall驱动很重要，替换了原有usbport驱动后蓝牙完美激活，隔空播放完美激活，无线网络速率大幅提升。
  - 硬盘升级为长江存储pc500固态，注意将oc设置-uefi设置-APFS中mindate和minversion设置成-1，引导界面看到安装分区即可正常使用。
